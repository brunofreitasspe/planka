...
export default {
  ...
  translation: {
    common: {
      ...
      allowedEmailDomains: 'Allowed e-mail domains',
      allowedEmailDomainsPlaceholder: 'example.com, example.org',
      allowSelfRegistration: 'Allow users to create their own account',
      alphabetically: 'Alphabetically',
      alwaysDisplayCardCreator: 'Always display card creator',
      apiKeyCreated_title: 'API Key Created',
      baseDn: 'Base DN',
      apiKey_title: 'API Key',
      approveRegistration_title: 'Approve Registration',
      archive: 'Archive',
      ...
      areYouSureYouWantToRejectThisRegistration:
      ...
      boardUserRoles: 'Board user roles',
      ...
      changeCustomFieldType_title: 'Change Custom Field Type',
      ...
      both: 'Both',
      csv: 'CSV',
      exportCards_title: 'Export Cards',
      ...
      kanban: 'Kanban',
      labelPermissionManagers: 'Managers only',
      labelPermissionMembers: 'Members can use',
      labels: 'Labels',
      language: 'Language',
      ...
      ldapServer_title: 'Server',
      ldapServiceAccount_title: 'Service Account',
      ldapSshTunnel_title: 'SSH Tunnel',
      ...
      projectOwnerRoles: 'Project owner roles',
      ...
      rejectRegistration_title: 'Reject Registration',
      ...
      role: 'Role',
      rolesAttribute: 'Roles attribute',
      ...
      url: 'URL',
      useLdaps: 'Use LDAPS (LDAP over TLS)',
