...
export default {
  ...
  translation: {
    common: {
      ...
      addOption_title: 'Adicionar opção',
      ...
      boardUserRoles: 'Funções de usuário do quadro',
      ...
      changeCustomFieldType_title: 'Alterar tipo de campo personalizado',
      changeType: 'Alterar tipo',
      changingTheTypeOfThisCustomFieldWillDeleteAllOfItsExistingValues:
        'Alterar o tipo deste campo personalizado excluirá todos os seus valores existentes.',
      ...
      enableLdapAuthentication: 'Ativar autenticação LDAP',
      ...
      both: 'Ambos',
      csv: 'CSV',
      exportCards_title: 'Exportar cards',
      ...
      kanban: 'Kanban',
      labelPermissionManagers: 'Apenas gerentes',
      labelPermissionMembers: 'Membros podem usar',
      labels: 'Rótulos',
      language: 'Idioma',
      ldap: 'LDAP',
      ldapAttributeMapping_title: 'Mapeamento de atributos LDAP',
      ldapRoleMapping_title: 'Mapeamento de função LDAP',
      ldapServer_title: 'Servidor LDAP',
      ldapServiceAccount_title: 'Conta de serviço LDAP',
      ldapSshTunnel_title: 'Túnel SSH LDAP',
      projectLabels: 'Etiquetas do Projeto',
      ...
      myOwn_title: 'Meus',
      name: 'Nome',
      nameAttribute: 'Atributo de nome',
      ...
      projectOwnerRoles: 'Funções de proprietário do projeto',
      ...
      role: 'Função',
      rolesAttribute: 'Atributo de funções',
      ...
      sshHostKeyFingerprint: 'Impressão digital da chave do host SSH',
      ...
      usernameAttribute: 'Atributo de nome de usuário',
      users: 'Usuários',
      viewer: 'Visualizador',
    ...
    action: {
      ...
      createProjectLabel: 'Criar etiqueta do projeto',
