...
export default function* projectLabelsWatchers() {
  yield all([
    takeEvery(EntryActionTypes.PROJECT_LABELS_IN_CURRENT_PROJECT_FETCH, () =>
      services.fetchProjectLabelsInCurrentProject(),
    ),
    takeEvery(EntryActionTypes.PROJECT_LABEL_IN_CURRENT_PROJECT_CREATE, ({ payload: { data } }) =>
      services.createProjectLabelInCurrentProject(data),
    ),
